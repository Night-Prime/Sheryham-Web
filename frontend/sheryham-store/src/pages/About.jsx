        ...
        <div className="md:w-3/4 h-max mx-auto px-10 flex flex-col gap-10 md:text-center text-justify">
          <div className="py-12">
            ...
            <p className="text-lg">
              ...
              or all individuals, through our classic, soft, and elegant
          ...
          <div className="py-12">
            ...
            <p className="text-lg">
              The vision is to become the leading clothing brand for all
              individuals, offering high-quality, stylish, and comfortable
              apparel that celebrates diversity and promotes self-confidence.
            </p>
          </div>
        </div>
      </main>
