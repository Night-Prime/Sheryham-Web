      ...
      <main className="mx-auto w-full h-full flex flex-row">
        <div className="flex-1">
          <main className="flex flex-col h-3/4 w-5/6 mx-auto my-10 justify-between">
            <div>
              <h1 className="text-gray-600 font-light text-[9px] lg:text-sm">
                <Link to="/">Home / </Link>
            ...
            <div className="flex flex-col gap-6">
              <div>
                <h1 className="font-semibold text-sm lg:text-md">
                  Description
                </h1>
              ...
              <div>
                <button
                  ...
                  className=" w-full h-10 lg:w-40 lg:h-10 bg-red-600 rounded-lg text-white hover:bg-white hover:text-red-600"
                >
